...
?>
        ...
        <tr>
            ...
            <?php echo '<td><center><div class="redirect"><a href="/jobCard.php?id=' . $agentID . '"<i class="fa fa-edit"></i></div></center></td>';?>
            <?php echo '<td><center><div class="redirect"><a href="/archiveAgent.php?id=' . $agentID . '"<i class="fa fa-user-times"></i></div></center></td>';?>
