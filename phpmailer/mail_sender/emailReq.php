...
$cleaning = $_SESSION['cleaning'];
if(isset($cleaning)) $cleaning = "CLEANING SERVICES - ";
$wrapping = $_SESSION['wrapping'];
...
$message = str_replace('%pet%', $pet, $message);
$message = str_replace('%car%', $car, $message);
$message = str_replace('%courier%', $courier , $message);
$message = str_replace('%shuttle%', $shuttle, $message);
$message = str_replace('%cleaning%', $cleaning, $message);
$message = str_replace('%wrapping%', $wrapping, $message);
$message = str_replace('%packing%', $packing, $message);
$message = str_replace('%insurance%', $insurance, $message);
